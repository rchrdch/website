...
const decoded: Template = {
  ...
  description: [
    ...
    "Product Team:",
    "Established a central platform to streamline product release notes and enable data analytics. Standardized staging and production settings for organizing external resources to accelerate efficiency and collaboration.",
